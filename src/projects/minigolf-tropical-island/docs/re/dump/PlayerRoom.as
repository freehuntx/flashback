...
class PlayerRoom extends MovieClip
{
   ...
   function itemRollOver(eventObject)
   {
      ...
      if(this.playerList.getItemAt(eventObject.index) != undefined)
      {
         ...
         this.stats.selPlayer.text = _loc2_.pName;
         AdminMenu.inst.setSelectedPlayerName(_loc2_.pName);
         this.stats.playerTotal.text = _loc2_.total;
         this.stats.playerWon.text = _loc2_.won;
         this.stats.playerLost.text = _loc2_.lost;
         this.stats.playerDrawn.text = _loc2_.drawn;
         this.stats.playerWinP.text = _loc2_.winP;
         this.stats.playerLevels.text = _loc2_.levels;
         this.stats.playerSwings.text = _loc2_.swings;
         this.stats.playerSwingsPerLevel.text = _loc2_.swingsPerLevel;
      }
   }
   ...
   {
      if(player1.label.substr(0,6) == "Player" && player2.label.substr(0,6) == "Player")
      {
